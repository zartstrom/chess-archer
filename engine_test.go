...
func TestNewFen_01(t *testing.T) {
    ...
    assert.Equal(t, f.board, "5k2/4n2p/1q2PBp1/p7/Q4P2/6P1/7P/2rR3K")
...
func TestSquareToPiece_01(t *testing.T) {
    s := "5k2/4n2p/1q2PBp1/p7/Q4P2/6P1/7P/2rR3K b - -"
    f := NewFen(s)
    assert.Equal(t, f.SquareToPiece("f8"), "k")
    assert.Equal(t, f.SquareToPiece("h1"), "K")
    assert.Equal(t, f.SquareToPiece("b6"), "q")
}
